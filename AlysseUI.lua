...
home.Image = "rbxassetid://127393374937080"
...
execbox.PlaceholderText = "-- Cảm ơn đã dùng Alysse by Duc Designer!"
execbox.Text = ""
...
searchbox.PlaceholderText = "Được cung cấp bởi Duc Designer"
searchbox.Text = ""
...
local function QIWXMR_fake_script() -- main.LocalScript 
	...
	print("Welcome, "..game.Players.LocalPlayer.Name.. " to Alysse by Duc Designer!.")
	...
	click(searchbutton, function()
		if issearching then
			game.StarterGui:SetCore("SendNotification", {
				Title = "Alysse",
				Text = "Một cuộc tìm kiếm hiện đang được tiến hành. Vui lòng đợi Biểu tượng tìm kiếm trở lại bình thường, điều này cho biết việc tìm kiếm đã kết thúc.",
				Duration = 1,
			})
			return
		end
		...
		wait(0.2)
		searchbutton.Image = "rbxassetid://127393374937080"
		wait(0.2)
...
function identifyexecutor()
    return "Alysse Android v2.0.0 | by Duc Designer"
end
